    ...
    <div class="form-section">
        ...
        <form method="POST" enctype="multipart/form-data" autocomplete="off" action="/profile">
            <div class="form-group">
                <?php if (!empty($user['image']) && file_exists('uploads/' . $user['image'])): ?>
                    <div class="current-image">
                        ...
                        <img src="uploads/<?= htmlspecialchars($user['image']) ?>" alt="Photo de profil">
                    </div>
                <?php endif; ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="prenoms" name="prenoms" value="<?= htmlspecialchars($user['prenoms']) ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" id="date_naissance" name="date_naissance" value="<?= htmlspecialchars($user['age']) ?>" required>
            </div>
